      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="flex justify-center text-black">
            {/* Logo */}
            <p className="text-2xl saira-font-bold flex items-center">
              <CiShop /> &nbsp;Otaku{" "}
          ...
          <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
            Bringing you the best anime merchandise, collectibles, and apparel.
          </p>
          {/* nav menu */}
          <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
            ...
            <li>
              <Link
                className="text-gray-700 transition hover:text-violet-600"
                to="https://chetan8383.github.io/Portfolio/#Portfolio"
                target="_blank"
              >
                {" "}
                Projects{" "}
        ...
        <span className="relative flex justify-center mb-5">
          ...
          <span className="relative bg-white px-6">
            ...
            <Link
              ...
              className="hover:text-violet-500 hover:underline duration-200"
            >
              Chetan Mehra
            </Link>
            <br />
